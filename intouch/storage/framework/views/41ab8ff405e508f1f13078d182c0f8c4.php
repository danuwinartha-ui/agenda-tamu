...
<body class="bg-[#0f172a] font-sans text-slate-200 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full">
        <div class="text-center mb-8">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" class="h-20 mx-auto drop-shadow-2xl mb-4">
        ...
        <div class="bg-[#1e293b] rounded-[2.5rem] shadow-2xl border border-slate-700/50 p-8">
            <form action="<?php echo e(route('login.auth')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Danu\2026\diskominfo-buku-tamu\resources\views/login.blade.php ENDPATH**/ ?>