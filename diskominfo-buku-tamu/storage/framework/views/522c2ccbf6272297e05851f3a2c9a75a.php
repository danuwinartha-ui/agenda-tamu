    ...
    <div class="max-w-md mx-auto min-h-screen bg-[#1e293b] shadow-2xl flex flex-col border-x border-slate-700/50">
        ...
        <div class="bg-[#1e293b] py-6 px-6 flex items-center justify-between border-b border-slate-700/50 sticky top-0 z-50">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('login')); ?>" class="active:scale-95 transition-transform">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" class="h-12 w-auto drop-shadow-lg" alt="Logo">
                </a>
                <div>
        ...
        <div class="p-6">
            ...
            <form id="guest-form" action="<?php echo e(route('guest.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Danu\2026\diskominfo-buku-tamu\resources\views/welcome.blade.php ENDPATH**/ ?>